...
double sensor_positions[6][3] = {
    ...
    {0.075,-0.04,1.5707},      // Short Range Left Front 
    {-0.0745,-0.04,1.507},     // Short Range Left Back
    {0.0745,0.04,-1.5707},       // Short Range Right Front 
    {-0.07,0.04,-1.5707},        // Short Range Right Back 
    {0.0225,0,0.0},           // Long Range Front  //or distance_sensor_forward_right_link
    {0.0225,0,0.0}             // Long Range Back? //or distance_sensor_forward_left_link
/*
    //{X,Y, Rotation Theta} Where pi/2 = 1.5707
